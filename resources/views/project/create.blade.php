                    ...
                    <div class="tab-content" id="nav-tabContent">
                        <div class="tab-pane active" id="step1">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group row mb-2">
                                        <label for="txtFirstNameBilling"
                                            class="col-lg-3 col-form-label text-end">Contact Person</label>
                                        <div class="col-lg-9">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group row mb-2">
                                        <label for="txtLastNameBilling" class="col-lg-3 col-form-label text-end">Mobile
                                            No.</label>
                                        <div class="col-lg-9">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group row mb-2">
                                        <label for="txtCompanyBilling" class="col-lg-3 col-form-label text-end">Landline
                                            No.</label>
                                        <div class="col-lg-9">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group row mb-2">
                                        <label for="txtEmailAddressBilling"
                                            class="col-lg-3 col-form-label text-end">Email Address</label>
                                        <div class="col-lg-9">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group row mb-2">
                                        <label for="txtAddress1Billing" class="col-lg-3 col-form-label text-end">Address
                                            1</label>
                                        <div class="col-lg-9">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group row mb-2">
                                        <label for="txtAddress2Billing"
                                            class="col-lg-3 col-form-label text-end">Warehouse Address</label>
                                        <div class="col-lg-9">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group row mb-2">
                                        <label for="txtCityBilling" class="col-lg-3 col-form-label text-end">Company
                                            Type</label>
                                        <div class="col-lg-9">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group row mb-2">
                                        <label for="txtStateProvinceBilling"
                                            class="col-lg-3 col-form-label text-end">Live Market A/C</label>
                                        <div class="col-lg-9">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group row mb-2">
                                        <label for="txtTelephoneBilling"
                                            class="col-lg-3 col-form-label text-end">Product Category</label>
                                        <div class="col-lg-9">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group row mb-2">
                                        <label for="txtFaxBilling" class="col-lg-3 col-form-label text-end">Product Sub
                                            Category</label>
                                        <div class="col-lg-9">
                        ...
                        <div class="tab-pane" id="step2">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group row mb-2">
                                        <label for="txtFirstNameShipping" class="col-lg-3 col-form-label text-end">PAN
                                            Card</label>
                                        <div class="col-lg-9">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group row mb-2">
                                        <label for="txtLastNameShipping"
                                            class="col-lg-3 col-form-label text-end">VAT/TIN No.</label>
                                        <div class="col-lg-9">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group row mb-2">
                                        <label for="txtCompanyShipping" class="col-lg-3 col-form-label text-end">CST
                                            No.</label>
                                        <div class="col-lg-9">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group row mb-2">
                                        <label for="txtEmailAddressShipping"
                                            class="col-lg-3 col-form-label text-end">Service Tax No.</label>
                                        <div class="col-lg-9">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group row mb-2">
                                        <label for="txtCityShipping" class="col-lg-3 col-form-label text-end">Company
                                            UIN</label>
                                        <div class="col-lg-9">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group row mb-2">
                                        <label for="txtStateProvinceShipping"
                                            class="col-lg-3 col-form-label text-end">Declaration</label>
                                        <div class="col-lg-9">
                        ...
                        <div class="tab-pane" id="step3">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group row mb-2">
                                        <label for="txtNameCard" class="col-lg-3 col-form-label text-end">Name on
                                            Card</label>
                                        <div class="col-lg-9">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group row mb-2">
                                        <label for="ddlCreditCardType" class="col-lg-3 col-form-label text-end">Credit
                                            Card Type</label>
                                        <div class="col-lg-9">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group row mb-2">
                                        <label for="txtCreditCardNumber" class="col-lg-3 col-form-label text-end">Credit
                                            Card Number</label>
                                        <div class="col-lg-9">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group row mb-2">
                                        <label for="txtCardVerificationNumber"
                                            class="col-lg-3 col-form-label text-end">Card Verification Number</label>
                                        <div class="col-lg-9">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group row mb-2">
                                        <label for="txtExpirationDate"
                                            class="col-lg-3 col-form-label text-end">Expiration Date</label>
                                        <div class="col-lg-9">
