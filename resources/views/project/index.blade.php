                ...
                <div class="row d-flex justify-content-center">
                    <div class="col">
                        ...
                        <p class="mb-0 text-truncate text-muted"><span class="text-success"><i
                                    class="mdi mdi-checkbox-marked-circle-outline me-1"></i></span>26 Project
                            Complete</p>
                    </div>
            ...
            <div class="card-body">
                <div class="row d-flex justify-content-center">
                    <div class="col">
                        ...
                        <p class="mb-0 text-truncate text-muted"><span class="text-dark">$14k</span> Total used
                            budgets</p>
                    </div>
                    <div class="col-auto align-self-center">
                        <div
                        ...
                        <div class="project-task-card mb-3">
                            <div class="card-body">
                                <div class="dropdown d-inline-block float-end">
                                    <a class="dropdown-toggle mr-n2 mt-n2" id="drop2" data-bs-toggle="dropdown" href="#"
                                ...
                                <p class="mb-2 text-muted fw-semibold font-13 text-break">Contrary to popular
                                    belief, Lorem Ipsum is not simply random text.</p>
                                <hr class="hr-dashed">
